 ...
 */
export async function validateSession(cookieValue: string, secret: string): Promise<string | null> {
 ...
 */
export function getSessionCookie(value: string, maxAge: number = DEFAULT_MAX_AGE): string {
  return [
