...
export const interactions = sqliteTable(
  ...
  (table) => [index('interactions_user_id_idx').on(table.userId)],
)
...
export const messages = sqliteTable(
  ...
  (table) => [index('messages_interaction_id_idx').on(table.interactionId)],
)
...
export const followUpChecks = sqliteTable(
  'follow_up_checks',
  {
    id: text('id').primaryKey(),
    userId: text('user_id')
