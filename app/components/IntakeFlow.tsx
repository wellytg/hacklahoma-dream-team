...
export const IntakeFlow: React.FC<{ isRetake?: boolean }> = ({ isRetake = false }) => {
  const { currentStep, nextStep, prevStep, state, updateState, setStep, getResolvedState } =
    useIntake()
            ...
            options={[
              {
                ...
                sublabel: 'Habit formation & accountability',
              },
              {
                id: 'starting',
                label: 'Starting tasks',
                sublabel: 'Overcoming that initial activation energy',
              },
              {
                id: 'energy',
                label: 'Managing energy',
                sublabel: 'Working with your natural rhythms',
              },
              {
                id: 'overwhelm',
                label: 'Reducing overwhelm',
                sublabel: 'Simplification & mental stability',
              },
              {
                id: 'stuck',
                label: "I don't know",
                sublabel: 'I just feel stuck and need a starting point',
              },
            ]}
        ...
        return (
          <QuestionStep
            ...
            options={[
              ...
              {
                id: 'emotional',
                label: 'Emotional effort',
                sublabel: 'Navigating feelings & stress',
              },
              {
                id: 'social',
                label: 'Social stuff',
                sublabel: 'Interacting, collaborating, or people pressure',
              },
            ...
            options={[
              {
                ...
                sublabel: 'Knowing exactly what to do',
              },
              { id: 'progress', label: 'Seeing progress', sublabel: 'Visual markers of movement' },
              {
                id: 'encouragement',
                label: 'Encouragement',
                sublabel: 'Warm feedback and support',
              },
            ...
            options={[
              {
                id: 'energy',
                label: 'Low energy',
                sublabel: "I simply don't have the gas in the tank",
              },
              {
                id: 'fear',
                label: 'Fear of doing it wrong',
                sublabel: 'Worrying about mistakes or failure',
              },
              {
                id: 'perfectionism',
                label: 'Perfectionism',
                sublabel: "The bar is so high I can't even reach it",
              },
              { id: 'boredom', label: 'Boredom', sublabel: "The task just doesn't interest me" },
              {
                id: 'direction',
                label: 'No starting point',
                sublabel: "I don't know the very first step",
              },
            ]}
        ...
        return (
          <QuestionStep
            ...
            options={[
              {
                id: 'sf',
                label: 'Structure then Freedom',
                sublabel: 'Guide me first, then let me go',
              },
              {
                id: 'fs',
                label: 'Freedom then Structure',
                sublabel: 'Let me explore, then help me organize',
              },
              { id: 'fulls', label: 'Mostly Structure', sublabel: 'I thrive on clear schedules' },
              {
                id: 'fullf',
                label: 'Mostly Flexibility',
                sublabel: 'I need room to breathe and pivot',
              },
            ]}
        ...
        return (
          <QuestionStep
            ...
            options={[
              {
                id: 'learn',
                label: "I didn't learn anything",
                sublabel: 'Growth and discovery matter most',
              },
              {
                id: 'progress',
                label: "I didn't make progress",
                sublabel: 'Forward movement is what counts',
              },
              ...
              {
                id: 'meaningful',
                label: "Busy but it didn't matter",
                sublabel: 'Impact over activity',
              },
            ]}
              ...
              <div className="mt-8 p-6 bg-stone-50 rounded-2xl border border-stone-100">
                <p className="text-stone-600 font-light italic leading-relaxed">
                  ...
                  {state.intent.length > 0
                    ...
                    : 'finding your rhythm'}
                  . We'll start by reducing {label(resolved.friction.primary).toLowerCase()}{' '}
                  pressure and focusing on {label(resolved.confidence.builder).toLowerCase()} to
                  build momentum."
                </p>
              </div>
            </div>

            {submitError && <p className="text-center text-red-600 text-sm mb-4">{submitError}</p>}
