      ...
      return (
        <div className="min-h-screen flex items-center justify-center px-6">
          <div className="text-center max-w-md">
            <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mx-auto mb-6 text-red-400">
              <svg
            ...
            <h1 className="text-2xl font-serif font-light text-stone-800 mb-3">
