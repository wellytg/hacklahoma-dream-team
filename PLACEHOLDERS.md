...
|-------------|-------------|---------|
| `hacklahoma-dream-team` | Project name (kebab-case recommended) | `my-awesome-project` |
| `Competition entry and development workspace for Hacklahoma` | Brief project description (1-2 sentences) | `A CLI tool for managing development workflows` |
...
| Placeholder | Description | Example |
|-------------|-------------|---------|
| `/Users/dde824/dev` | Absolute path to workspace root | `/Users/username/dev` |
